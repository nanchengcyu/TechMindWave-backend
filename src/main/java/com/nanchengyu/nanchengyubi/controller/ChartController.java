...
import com.nanchengyu.nanchengyubi.model.dto.controller.ChartGenController;
...
public class ChartController {
     ...
     * 获取查询包装类
     *
     * @param chartQueryRequest 图表查询条件
     * @return 查询结果
     */
...
//    @PostMapping("/gen/mq")
    ...
    public BaseResponse<BiResponse> genChartMQ(@RequestPart("file") MultipartFile multipartFile,
        ...
        ChartGenController chartGenController = new ChartGenController(genChartByAiRequest.getChartName(), genChartByAiRequest.getGoal(),genChartByAiRequest.getChartType(), loginUser);
