...
import com.nanchengyu.nanchengyubi.model.vo.AiResponse;
import com.nanchengyu.nanchengyubi.bizmq.MqMessageProducer;
...
import com.nanchengyu.nanchengyubi.constant.*;
...
import com.nanchengyu.nanchengyubi.model.dto.text.*;
import com.nanchengyu.nanchengyubi.model.entity.TextRecord;
import com.nanchengyu.nanchengyubi.model.entity.TextTask;
import com.nanchengyu.nanchengyubi.model.entity.User;
import com.nanchengyu.nanchengyubi.model.vo.TextTaskVO;
import com.nanchengyu.nanchengyubi.service.TextRecordService;
import com.nanchengyu.nanchengyubi.service.TextTaskService;
...
import com.nanchengyu.nanchengyubi.utils.TxtUtils;
...
public class TextController {
    ...
    public BaseResponse<AiResponse> genTextTaskAsyncAiMq(@RequestPart("file") MultipartFile multipartFile,
        ...
        mqMessageProducer.sendMessage(BiMqConstant.TEXT_EXCHANGE_NAME, BiMqConstant.TEXT_ROUTING_KEY, String.valueOf(taskId));
        //返回数据参数
        AiResponse aiResponse = new AiResponse();
        aiResponse.setResultId(textTask.getId());
        return ResultUtils.success(aiResponse);
    ...
    public BaseResponse<AiResponse> genTextTaskAsyncAiRebuild(TextRebuildRequest textRebuildRequest, HttpServletRequest request) {
        ...
        mqMessageProducer.sendMessage(BiMqConstant.TEXT_EXCHANGE_NAME, BiMqConstant.TEXT_ROUTING_KEY, String.valueOf(textTaskId));
        //返回数据参数
        AiResponse aiResponse = new AiResponse();
        aiResponse.setResultId(textTask.getId());
        return ResultUtils.success(aiResponse);
