...
import com.nanchengyu.nanchengyubi.model.dto.aiassistant.*;
import com.nanchengyu.nanchengyubi.model.entity.AiAssistant;
import com.nanchengyu.nanchengyubi.model.entity.User;
import com.nanchengyu.nanchengyubi.model.enums.AiAssistantStatusEnum;
...
public class AiAssistantController {
    ...
    public BaseResponse<?> aiAssistant(@RequestBody GenChatByAiRequest genChatByAiRequest, HttpServletRequest request) throws IOException {
        ...
        rabbitTemplate.convertAndSend(BiMqConstant.AI_QUESTION_EXCHANGE_NAME, BiMqConstant.AI_QUESTION_ROUTING_KEY, json);
