...
public class BiMqMessageConsumer {
    ...
    private void receiveMessage(String message, Channel channel, @Header(AmqpHeaders.DELIVERY_TAG) long deliveryTag) {
        ...
        // 调用AI
        String promote = AiManager.PRECONDITION + "分析需求 " + chart.getGoal() + " \n原始数据如下: " + chart.getChartData() + "\n生成图标的类型是: " + chart.getChartType();
        String chartResult = aiManager.sendMesToAIUseXingHuo(promote);
