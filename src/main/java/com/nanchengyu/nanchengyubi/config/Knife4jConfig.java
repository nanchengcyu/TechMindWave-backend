...
public class Knife4jConfig {
    ...
    public Docket defaultApi2() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                // 指定 Controller 扫描包路径
                .apis(RequestHandlerSelectors.basePackage("com.nanchengyu.nanchengyubi.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("nanchengyu", "https://github.com/nanchengcyu", "nanchengyu02@qq.com"))
                // 版本
                .version("1.0")
                // 构建
                .build();
