...
) ENGINE = InnoDB AUTO_INCREMENT = 1691395065563369474 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'AI 问答助手信息表' ROW_FORMAT = Dynamic;
...
INSERT INTO `ai_frequency` VALUES (1690946228424089601, 1690946228361175042, 3, 2, '2023-08-14 12:39:31', '2023-08-14 12:39:31', 0);
...
CREATE TABLE `ai_frequency_order`  (
  ...
  `isDelete` tinyint(4) NOT NULL DEFAULT 0 COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1691346191431847939 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '次数订单表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `alipay_info`  (
  ...
  `isDelete` tinyint(4) NOT NULL DEFAULT 0 COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1690750426309292034 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '次数订单表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `chart`  (
  ...
  `isDelete` tinyint(4) NOT NULL DEFAULT 0 COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1691359037385428995 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '图表信息表' ROW_FORMAT = Dynamic;
...
INSERT INTO `credit` VALUES (3, 1690946228361175042, 10197, '2023-08-14 12:42:38', '2023-08-17 11:01:05', 0);
...
CREATE TABLE `text_record`  (
  ...
  `isDelete` tinyint(4) NOT NULL DEFAULT 0 COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1692008620474023940 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '文本记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `text_task`  (
  ...
  `isDelete` tinyint(4) NOT NULL DEFAULT 0 COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1692008620474023939 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '文本任务表' ROW_FORMAT = Dynamic;
